 ...
 *    98 : 100kΩ HT-NTC-100k - Same as #1, adjusted for offset/variance
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 187.4 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1400, 1400, 120, 1200 }

#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 10000, 10000, 300, 10000 } // ...or, set your own edit limits
#endif
...
//#define CLASSIC_JERK
  ...
  #define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 25, 25, 2, 25 } // ...or, set your own edit limits
  #endif
#endif
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_HOTEND_TEMP  245    // (°C) Default nozzle temperature for G26.
    #define MESH_TEST_BED_TEMP      75    // (°C) Default bed temperature for G26.
...
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
  ...
  //#define EEPROM_INIT_NOW     // Init EEPROM on first boot after a new build  // disable force reset EEPROM
#endif
...
#define PREHEAT_5_LABEL       "Custom" // TPU
...
#define NOZZLE_PARK_FEATURE  // MRiscoC Enabled
  ...
  #define NOZZLE_PARK_POINT { 0, 200, 20 } //changed MRiscoC Customizable by menu
  ...
  #define NOZZLE_PARK_XY_FEEDRATE 135   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
 ...
 */
//#define NOZZLE_CLEAN_FEATURE          // (1440 bytes)
