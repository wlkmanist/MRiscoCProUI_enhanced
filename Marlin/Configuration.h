...
#define CUSTOM_MACHINE_NAME "project.black Aquila"
...
#define TMC_UART_PIN_E PA13       // HW mod for E0 driver (R8 jumper to DIO pin)
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 93.7 }
